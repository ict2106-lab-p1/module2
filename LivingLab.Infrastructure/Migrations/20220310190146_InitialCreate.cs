...
namespace LivingLab.Infrastructure.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Accessories",
                columns: new[] { "Id", "AccessoryTypeId", "LabId", "LabUserId", "LastUpdated", "Status" },
                values: new object[] { 1, 1, 1, null, new DateTime(2021, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Available" });

            migrationBuilder.InsertData(
                table: "Accessories",
                columns: new[] { "Id", "AccessoryTypeId", "LabId", "LabUserId", "LastUpdated", "Status" },
                values: new object[] { 2, 1, 1, "User1", new DateTime(2021, 10, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "Borrowed" });

            migrationBuilder.InsertData(
                table: "Accessories",
                columns: new[] { "Id", "AccessoryTypeId", "LabId", "LabUserId", "LastUpdated", "Status" },
                values: new object[] { 3, 2, 1, null, new DateTime(2021, 10, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "Available" });

            migrationBuilder.InsertData(
                table: "Accessories",
                columns: new[] { "Id", "AccessoryTypeId", "LabId", "LabUserId", "LastUpdated", "Status" },
                values: new object[] { 4, 2, 1, null, new DateTime(2021, 10, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "Available" });

            migrationBuilder.InsertData(
                table: "Accessories",
                columns: new[] { "Id", "AccessoryTypeId", "LabId", "LabUserId", "LastUpdated", "Status" },
                values: new object[] { 5, 3, 1, "User1", new DateTime(2021, 9, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), "Borrowed" });

            migrationBuilder.InsertData(
                table: "Accessories",
                columns: new[] { "Id", "AccessoryTypeId", "LabId", "LabUserId", "LastUpdated", "Status" },
                values: new object[] { 6, 3, 1, null, new DateTime(2021, 9, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "Available" });

            migrationBuilder.InsertData(
                table: "Accessories",
                columns: new[] { "Id", "AccessoryTypeId", "LabId", "LabUserId", "LastUpdated", "Status" },
                values: new object[] { 7, 4, 1, null, new DateTime(2021, 8, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Available" });

            migrationBuilder.InsertData(
                table: "Accessories",
                columns: new[] { "Id", "AccessoryTypeId", "LabId", "LabUserId", "LastUpdated", "Status" },
                values: new object[] { 8, 4, 1, "User1", new DateTime(2021, 8, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Borrowed" });

            migrationBuilder.InsertData(
                table: "Accessories",
                columns: new[] { "Id", "AccessoryTypeId", "LabId", "LabUserId", "LastUpdated", "Status" },
                values: new object[] { 9, 5, 1, null, new DateTime(2021, 7, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), "Available" });

            migrationBuilder.InsertData(
                table: "Accessories",
                columns: new[] { "Id", "AccessoryTypeId", "LabId", "LabUserId", "LastUpdated", "Status" },
                values: new object[] { 10, 5, 1, "User1", new DateTime(2021, 6, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Borrowed" });

            migrationBuilder.InsertData(
                table: "Accessories",
                columns: new[] { "Id", "AccessoryTypeId", "LabId", "LabUserId", "LastUpdated", "Status" },
                values: new object[] { 11, 6, 1, null, new DateTime(2021, 7, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "Available" });

            migrationBuilder.InsertData(
                table: "Accessories",
                columns: new[] { "Id", "AccessoryTypeId", "LabId", "LabUserId", "LastUpdated", "Status" },
                values: new object[] { 12, 6, 1, null, new DateTime(2021, 4, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), "Available" });

            migrationBuilder.InsertData(
                table: "Accessories",
                columns: new[] { "Id", "AccessoryTypeId", "LabId", "LabUserId", "LastUpdated", "Status" },
                values: new object[] { 13, 7, 1, "User1", new DateTime(2021, 7, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), "Borrowed" });

            migrationBuilder.InsertData(
                table: "Accessories",
                columns: new[] { "Id", "AccessoryTypeId", "LabId", "LabUserId", "LastUpdated", "Status" },
                values: new object[] { 14, 7, 1, "user1", new DateTime(2021, 12, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "Borrowed" });

            migrationBuilder.InsertData(
                table: "Accessories",
                columns: new[] { "Id", "AccessoryTypeId", "LabId", "LabUserId", "LastUpdated", "Status" },
                values: new object[] { 15, 8, 1, null, new DateTime(2021, 11, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Available" });

            migrationBuilder.InsertData(
                table: "Accessories",
                columns: new[] { "Id", "AccessoryTypeId", "LabId", "LabUserId", "LastUpdated", "Status" },
                values: new object[] { 16, 8, 1, null, new DateTime(2021, 7, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), "Available" });
