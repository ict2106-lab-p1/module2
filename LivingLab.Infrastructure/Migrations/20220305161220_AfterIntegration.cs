        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EnergyUsageLogs_Device_DeviceId",
                        column: x => x.DeviceId,
                        principalTable: "Device",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EnergyUsageLogs_Lab_LabId",
                        column: x => x.LabId,
                        principalTable: "Lab",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Lab",
                columns: new[] { "Id", "Area", "LabStatus", "Location", "PersonInCharge" },
                values: new object[] { 1, 12.0, "Available", "NYP-SR7C", "Mr Tan" });

            migrationBuilder.InsertData(
                table: "Lab",
                columns: new[] { "Id", "Area", "LabStatus", "Location", "PersonInCharge" },
                values: new object[] { 2, 12.0, "Available", "NYP-SR7C", "Mr Tan" });

            migrationBuilder.InsertData(
                table: "Lab",
                columns: new[] { "Id", "Area", "LabStatus", "Location", "PersonInCharge" },
                values: new object[] { 3, 12.0, "Available", "NYP-SR7C", "Mr Tan" });

            migrationBuilder.InsertData(
                table: "Lab",
                columns: new[] { "Id", "Area", "LabStatus", "Location", "PersonInCharge" },
                values: new object[] { 4, 12.0, "Available", "NYP-SR7C", "Mr Tan" });
            ...
            migrationBuilder.InsertData(
                table: "Device",
                columns: new[] { "Id", "Description", "DeviceSerialNumber", "EnergyUsageThreshold", "LabId", "LastUpdated", "Status", "Type" },
                values: new object[] { 1, "Its purpose is to detect situation in the laboratory", "SC1001", null, 1, new DateTime(2020, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Available", "Surveillance Camera" });

            migrationBuilder.InsertData(
                table: "Device",
                columns: new[] { "Id", "Description", "DeviceSerialNumber", "EnergyUsageThreshold", "LabId", "LastUpdated", "Status", "Type" },
                values: new object[] { 2, "Its purpose is to detect temperature in the laboratory", "R1001", null, 1, new DateTime(2020, 10, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "Available", "Temperature Sensor" });

            migrationBuilder.InsertData(
                table: "Device",
                columns: new[] { "Id", "Description", "DeviceSerialNumber", "EnergyUsageThreshold", "LabId", "LastUpdated", "Status", "Type" },
                values: new object[] { 3, "Its purpose is to detect humidity in the laboratory", "S1001", null, 1, new DateTime(2020, 9, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), "Available", "Humidity Sensor" });

            migrationBuilder.InsertData(
                table: "Device",
                columns: new[] { "Id", "Description", "DeviceSerialNumber", "EnergyUsageThreshold", "LabId", "LastUpdated", "Status", "Type" },
                values: new object[] { 4, "Its purpose is to detect light in the laboratory", "SL1001", null, 1, new DateTime(2019, 8, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Available", "Light Sensor" });

            migrationBuilder.InsertData(
                table: "Device",
                columns: new[] { "Id", "Description", "DeviceSerialNumber", "EnergyUsageThreshold", "LabId", "LastUpdated", "Status", "Type" },
                values: new object[] { 5, "It is used to control brightness of the lights in the lab", "VRL1001", null, 1, new DateTime(2019, 7, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), "Unavailable", "VR Light Controls" });
