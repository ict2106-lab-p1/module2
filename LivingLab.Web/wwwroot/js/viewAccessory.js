  ...
  var table = $("#table_id").DataTable({
    ...
    columnDefs: [
      ...
      },
      {
        ...
        data: null,
        defaultContent:
          "<button class='hover:bg-sunset-400 font-large rounded-lg text-sm px-5 py-2.5'><i class='bi bi-pencil'></i></button>",
      ...
      },
      {
        ...
        data: null,
        defaultContent:
          "<button class='hover:bg-red-300 font-large rounded-lg text-sm px-5 py-2.5 '><i class='bi bi-trash'></i></button>",
